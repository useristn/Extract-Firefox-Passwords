...
class SimpleHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        # Nhận file .tar.gz và lưu vào thư mục received_files
        ...
        # Giải nén file .tar.gz và lưu vào thư mục extracted_files
        try:
        ...
        # Chạy script python decryption.py -d <path_to_profile_directory>
        try:
        ...
        # Lưu kết quả vào thư mục exploited_results
        try:
